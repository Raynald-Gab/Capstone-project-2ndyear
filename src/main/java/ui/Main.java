...
public class Main {
    ...
    static Section IT2C = new Section("IT2C", 40, null);
    static Section IT2A = new Section("IT2A", 30, null);
    static Section IT2B = new Section("IT2B", 30, null);
    static Section IT2D = new Section("IT2D", 30, null);
    ...
    static void instructorMenu() {
        ...
        try {
            ...
            if (c == 1) {
                ...
                System.out.print("Instructor ID: "); String iid = sc.nextLine().trim();
                Instructor instructor = instructorService.findInstructorById(iid);
